...
public class BleUtilitiesDevice {
	...
	public static final UUID Characteristic = UUID.fromString("0000fe84-0000-0001-8000-00805f9b34fb");
	...
	@Keep
	public static native void onServiceSet(String guid);
				...
				_activity.runOnUiThread(new Runnable() {
					...
					public void run() {
						if (status == BluetoothGatt.GATT_SUCCESS) {
							...
							// For some reason, the characteristic and service is swapped sometimes
							if(service == null)
							{
								service = gatt.getService(Characteristic);
							}
							if (service != null) {
								_service = service;
								onServiceSet(_managerId);
