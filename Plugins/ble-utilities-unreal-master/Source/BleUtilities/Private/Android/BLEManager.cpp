...
void UBLEManager::ConnectToDevice(TScriptInterface<IBLEDeviceInterface> device,
	const FOnDeviceConnectedDelegate& onDeviceConnectedCallback, const FOnConnectionErrorDelegate& onFailToConnectDeviceCallback, const FOnServiceSetDelegate& onServiceSetCallback)
{
	...
	OnServiceSetDelegate = onServiceSetCallback;
...
void UBLEManager::OnServiceSet()
{
	OnServiceSetDelegate.ExecuteIfBound();
}
